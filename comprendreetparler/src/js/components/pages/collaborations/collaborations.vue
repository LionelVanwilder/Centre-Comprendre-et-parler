<template>
    <div class="programmes-container">
        <div class="programmes-nav">
            <ul>
                <li><router-link to="/Competences/Accompagnements">Partenaires privilégiés</router-link></li>
                <li><router-link to="/Competences/AssistancesSociales">Autres collaborations</router-link></li>
                <li><router-link to="/Competences/Audiologie">Rayonnement du centre</router-link></li>
            </ul>
        </div>
